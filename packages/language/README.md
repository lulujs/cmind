...
- [src/cmind.langium](src/cmind.langium) -  The grammar definition of your language
- [src/cmind-module.ts](src/cmind-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/cmind-validator.ts](src/cmind-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/cmind.monarch.ts](src/syntaxes/cmind.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/cmind.tmLanguage.json](syntaxes/cmind.tmLanguage.json) - Textmate based syntax highlighting instructions.
