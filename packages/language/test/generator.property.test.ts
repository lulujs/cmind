...
- task5 @priority(1) @progress(9) @bold @italic`;
  ...
  test("Property 5: Children array is correctly generated", async () => {
    await fc.assert(
      fc.asyncProperty(fc.integer({ min: 0, max: 5 }), async (numChildren) => {
