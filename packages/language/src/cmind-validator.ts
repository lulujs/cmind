...
import type { CmindAstType, MindMap, PriorityAttribute, ProgressAttribute, ChildNode } from './generated/ast.js';
...
export class CmindValidator {
     ...
     * Requirements: 3.6
     */
    checkPriorityRange(attr: PriorityAttribute, accept: ValidationAcceptor): void {
    ...
    /**
     * Validate progress attribute is between 1-9.
     * Requirements: 3.6
     */
    checkProgressRange(attr: ProgressAttribute, accept: ValidationAcceptor): void {
        if (attr.value < 1 || attr.value > 9) {
            accept('error', 'Progress must be between 1 and 9', {
                node: attr,
                property: 'value'
            });
        }
    ...
    checkIndentation(node: ChildNode, accept: ValidationAcceptor): void {
        ...
        if (hasTabs && hasSpaces) {
            accept('warning', 'Inconsistent indentation detected: mixing tabs and spaces', {
                node: node,
                property: 'text'
            });
        }
